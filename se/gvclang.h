...
#define AACOPY13 "kräver Licensen att copyright notice och denna notice skall"
...
#define AAADVANCEDPSOPT "Avancerade PostScript Optioner"
...
#define AAEDITPROPERTIES "Editera Inställningar"
...
#define AAGHOSTSCRIPTOTHERC "Ghostscript Optioner:"
#define AACOPYPRINTERDEF "Kopiera Skrivarstandard"
#define AAASSOCIATEPS "Associera .ps filer med GSview"
#define AAASSOCIATEPDF "Associera .pdf files med GSview"
...
#define AADRIVEROPTIONSC "Drivrutin optioner:"
...
#define AAINSTALLCONFIG3 "Följande rad kommer att läggas till din autooexec.bat\r     SET TEMP=C:\\"
...
#define AAZIPNOTFOUND "Zip fil kunde inte hittas"
...
#define AACFG30 "GSview håller en lista på Ghostscript utskrifts devices och\
 upplösningar i sin initieringsfil."
#define AACFG31 "Standardlista över devices och upplösningar är tagen från standard\
...
#define AACFG52 "Namn"
#define AACFG53 "GSview kan skapa ett Skrivbords Programobjekt för GSview. \
...
#define AACFG72 "Om du behöver ändra konfigurationen senare,\
 kör GSview och välj sedan \042Optioner | Enkel Konfiguration ..\042 eller\
 \042Optioner | Avancerad Konfiguration..\042."
