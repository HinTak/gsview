...
#define GSVIEW_COPYRIGHT1 "AutorskÈ pr·va (C) 1993-2003 Ghostgum Software Pty Ltd."
#define GSVIEW_COPYRIGHT2 "Vöetky pr·va vyhradenÈ."
#define GSVIEW_COPYRIGHT3 "Pozrite si s˙bor LICENCE pre viac inform·ciÌ."

#define GS_COPYRIGHT1 "AutorskÈ pr·va (C) 1994-2002 artofcode LLC,"
...
#define AAREG2 ""
#define AANAG1 "GSview autorskÈ pr·va 2003 Ghostgum Software Pty Ltd."
