...
*/
  ...
  { "/Options/Language/_French", 	NULL,		GS_CMD, IDM_LANGFR, "<CheckItem>" },
  { "/Options/Language/_German", 	NULL,		GS_CMD, IDM_LANGDE, "<CheckItem>" },
  { "/Options/Language/_Italian", 	NULL,		GS_CMD, IDM_LANGIT, "<CheckItem>" },
  { "/Options/Language/_Spanish", 	NULL,		GS_CMD, IDM_LANGES, "<CheckItem>" },
