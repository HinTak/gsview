...
*/
  ...
  { "/Opciones/Idioma/_Inglés", 	NULL,		GS_CMD, IDM_LANGEN, "<CheckItem>" },
  { "/Opciones/Idioma/_Francés", 	NULL,		GS_CMD, IDM_LANGFR, "<CheckItem>" },
  { "/Opciones/Idioma/_Alemán", 	NULL,		GS_CMD, IDM_LANGDE, "<CheckItem>" },
  { "/Opciones/Idioma/I_taliano", 	NULL,		GS_CMD, IDM_LANGIT, "<CheckItem>" },
  { "/Opciones/Idioma/_Español", 	NULL,		GS_CMD, IDM_LANGES, "<CheckItem>" },
