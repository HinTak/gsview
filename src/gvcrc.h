...
#define IDD_PDF2PS	 460
#define PDF2PS_BINARYOK	 461
#define PDF2PS_LEVEL1	 462
#define PDF2PS_NOPROCSET 463
#define OPTION_PDF2PS_BINARYOK	 1	/* bit masks */
