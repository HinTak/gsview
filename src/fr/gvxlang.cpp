...
*/
  ...
  { "/Options/Langue/_Anglais", 	NULL,		GS_CMD, IDM_LANGEN, "<CheckItem>" },
  { "/Options/Langue/_Français", 	NULL,		GS_CMD, IDM_LANGFR, "<CheckItem>" },
  { "/Options/Langue/_Allemand", 	NULL,		GS_CMD, IDM_LANGDE, "<CheckItem>" },
  { "/Options/Langue/_Italien", 	NULL,		GS_CMD, IDM_LANGIT, "<CheckItem>" },
  { "/Options/Langue/_Espagnol", 	NULL,		GS_CMD, IDM_LANGES, "<CheckItem>" },
