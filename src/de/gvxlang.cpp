...
*/
  ...
  { "/Optionen/Sprache/_Englisch", 	NULL,		GS_CMD, IDM_LANGEN, "<CheckItem>" },
  { "/Optionen/Sprache/_Französisch", 	NULL,		GS_CMD, IDM_LANGFR, "<CheckItem>" },
  { "/Optionen/Sprache/_Deutsch", 	NULL,		GS_CMD, IDM_LANGDE, "<CheckItem>" },
  { "/Optionen/Sprache/_Italienisch", 	NULL,		GS_CMD, IDM_LANGIT, "<CheckItem>" },
  { "/Optionen/Sprache/_Spanisch", 	NULL,		GS_CMD, IDM_LANGES, "<CheckItem>" },
