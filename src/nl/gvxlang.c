...
MENU_ENTRY menu_nl[] = {
  ...
  { "/Bestand/_Bestand selecteren...",    "S", 	GS_CMD,	IDM_SELECT, NULL },
  { "/Bestand/Opslaan _Als......",     	"A", 	GS_CMD,	IDM_SAVEAS, NULL },
  { "/Bestand/_Sluiten",     	"C", 	GS_CMD,	IDM_CLOSE, NULL },
  { "/Bestand/_Info...",     	"I", 	GS_CMD,	IDM_INFO, NULL },
  { "/Bestand/sep1",     		NULL,   NULL, 		0, "<Separator>" },
  { "/Bestand/_Omzetten...",     	NULL, 	GS_CMD,	IDM_CONVERTFILE, NULL },
  { "/Bestand/_Uitpakken...",     	"E", 	GS_CMD,	IDM_EXTRACT, NULL },
  { "/Bestand/PS naar EPS",     	NULL, 	GS_CMD,	IDM_PSTOEPS, NULL },
  { "/Bestand/sep2",     		NULL,   NULL, 		0, "<Separator>" },
  { "/Bestand/_Afdrukken...",     	"P", 	GS_CMD,	IDM_PRINT, NULL },
  { "/Bestand/Van de schijf afdrukken...",     	NULL, 	GS_CMD,	IDM_SPOOL, NULL },
  { "/Bestand/sep3",     		NULL,   NULL, 		0, "<Separator>" },
  { "/Bestand/Berichten tonen",     	"M", 	GS_CMD,	IDM_GSMESS, NULL },
...
/*
  { "/Bewerken/_Kopi‰ren",     		"<control>C", GS_CMD, IDM_COPYCLIP, NULL },
  { "/Bewerken/sep1",     		NULL,   NULL, 		0, "<Separator>" },
  { "/Bewerken/Bitmap omzetten",    NULL,	GS_CMD,	IDM_CONVERT, NULL },
*/
  { "/Bewerken/Plakken"/* WRONG */,     	NULL,	GS_CMD,	IDM_PASTETO, NULL },
  { "/Bewerken/sep2",     		NULL,   NULL, 		0, "<Separator>" },
  { "/Bewerken/EPSvoorbeeld toevoegen",   NULL,   NULL, 		0, "<Branch>" },
  { "/Bewerken/EPSvoorbeeld toevoegen/Verwisselbaar", NULL,		GS_CMD, IDM_MAKEEPSI, NULL },
  { "/Bewerken/EPSvoorbeeld toevoegen/TIFF 4", NULL,		GS_CMD, IDM_MAKEEPST4, NULL },
  { "/Bewerken/EPSvoorbeeld toevoegen/TIFF 6 niet gecompromeerd", NULL,	GS_CMD, IDM_MAKEEPST6U, NULL },
  { "/Bewerken/EPSvoorbeeld toevoegen/TIFF 6 packbits", NULL,	GS_CMD, IDM_MAKEEPST6P, NULL },
  { "/Bewerken/EPSvoorbeeld toevoegen/Windows Meta Bestand", NULL,	GS_CMD, IDM_MAKEEPSW, NULL },
  { "/Bewerken/EPSvoorbeeld toevoegen/Voorbeeld ingesteld door de gebruiker",NULL,GS_CMD, IDM_MAKEEPSU, NULL },
  { "/Bewerken/_EPS Uitpakken",   NULL,   NULL, 	IDM_EXTEPSMENU, "<Branch>" },
  { "/Bewerken/EPS Uitpakken/PostScript", NULL,		GS_CMD, IDM_EXTRACTPS, NULL },
  { "/Bewerken/EPS Uitpakken/Voorbeeld", NULL,			GS_CMD, IDM_EXTRACTPRE, NULL },
  { "/Bewerken/sep3",     		NULL,   NULL, 		0, "<Separator>" },
  { "/Bewerken/Meeteenheid", NULL,				GS_CMD, IDM_MEASURE, NULL },
  { "/Bewerken/Omzetten naar vectorieel formaat...", NULL,		GS_CMD, IDM_PSTOEDIT, NULL },
  { "/Bewerken/_Tekst Uipakken...", NULL,			GS_CMD, IDM_TEXTEXTRACT, NULL },
  ...
  { "/Opties/Eenheidsmaten",      		NULL,   NULL, 		0, "<Branch>" },
  { "/Opties/Eenheidsmaten/_pt", 		NULL,		GS_CMD, IDM_UNITPT, "<CheckItem>" },
  { "/Opties/Eenheidsmaten/_mm", 		NULL,		GS_CMD, IDM_UNITMM, "<CheckItem>" },
  { "/Opties/Eenheidsmaten/_duim", 		NULL,		GS_CMD, IDM_UNITINCH, "<CheckItem>" },
  { "/Opties/Eenheidsmaten/sep1",     		NULL,   NULL, 		0, "<Separator>" },
  { "/Opties/Eenheidsmaten/Beste _Resolutie", 	NULL,		GS_CMD, IDM_UNITFINE, "<CheckItem>" },
  ...
  { "/Opties/Jongste Directory bewaren", 	NULL,		GS_CMD, IDM_SAVEDIR, "<CheckItem>" },
...
/*  { "/Opties/Venster aan de bladzijde aanpassen", 	NULL,		GS_CMD, IDM_FITPAGE, "<CheckItem>" }, */
  ...
  { "/Bekijken/Terug", 		"B",	GS_CMD, 	IDM_GOBACK, NULL },
  { "/Bekijken/Verder",	NULL,	GS_CMD, 	IDM_GOFWD, NULL },
  { "/Bekijken/Opnieuw Tonen", 	"R",	GS_CMD, 	IDM_REDISPLAY, NULL },
  { "/Bekijken/sep1",     		NULL,   NULL, 		0, "<Separator>" },
  { "/Bekijken/Volgende Bladzijde en Bovenaan", "space",	GS_CMD, 	IDM_NEXTHOME, NULL },
  ...
  { "/Orientatie/_Onderste boven", 	NULL,	GS_CMD, 	IDM_UPSIDEDOWN, "<CheckItem>" },
  ...
  { "/Papierformaat/_Instellingen tonen...", NULL,GS_CMD, 	IDM_DISPLAYSETTINGS, NULL },
  ...
  { "/_Hulp",      		"F1",   NULL, 		0, "<Branch>" },
  { "/Hulp/_Inhoud", 		NULL,	GS_CMD, 	IDM_HELPCONTENT, NULL },
  { "/Hulp/_Hulp zoeken over", NULL,	GS_CMD, 	IDM_HELPSEARCH, NULL },
  { "/Hulp/_Toetsen", 	NULL,	GS_CMD, 	IDM_HELPKEYS, NULL },
  { "/Hulp/sep1",		NULL,   NULL, 		0, "<Separator>" },
  { "/Hulp/_GSview _Registreren...", 	NULL,	GS_CMD, 	IDM_REGISTER, NULL },
  { "/Hulp/_Over GSview...", 		NULL,	GS_CMD, 	IDM_ABOUT, NULL },
};
