...
*/
  ...
  { "/Opzioni/Lingua/Ingl_ese", 	NULL,		GS_CMD, IDM_LANGEN, "<CheckItem>" },
  { "/Opzioni/Lingua/_Francese", 	NULL,		GS_CMD, IDM_LANGFR, "<CheckItem>" },
  { "/Opzioni/Lingua/Te_desco", 	NULL,		GS_CMD, IDM_LANGDE, "<CheckItem>" },
  { "/Opzioni/Lingua/_Italiano", 	NULL,		GS_CMD, IDM_LANGIT, "<CheckItem>" },
  { "/Opzioni/Lingua/_Spagnolo", 	NULL,		GS_CMD, IDM_LANGES, "<CheckItem>" },
